...
"""
        ...
        def generate_quest(message):
            ...
            if q_type == 'alive': #разделила квесты на те, которые можно поручить, если цель живая или если цель - предмет, потому что иначе там надо было убить древний артефакт :D
